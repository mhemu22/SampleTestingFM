...
//			sassert.assertEquals(stepstatus, true);
		...
		protected  void reportEvent(boolean stepstatus,String PassMessage, String FailMessage,WebDriver driver,boolean takescrrenshot) 
		{
			...
			{
				FrameworkVariables.getInstance().setExtentTest(FrameworkVariables.getInstance().getExtentReports().startTest(FrameworkVariables.getInstance().getCurrentModuleName() + "_" + FrameworkVariables.getInstance().getCurrentTestCaseName()));
